...
Uninstall is intentionally not a documented data-erasure guarantee. Installer, uninstall, and clean-Windows checks are **NOT RUN**; use Clear all data for the product-level local-data/credential operation.
